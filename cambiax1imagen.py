...
with my_selfie.SelfieSegmentation(0) as selfie_segmentation:
  while True:
    ...
    # crear background imagen rosa
    # leer imagen
    bg_image=cv2.imread("20211210_162240.jpg")
    ...
    output_image=cv2.add(bg,fg)# suma bien porque bg tiene negro la parte visible y fg tiene la parte invisible negro / negro significa 0 entonces al sumarse solo queda el color
